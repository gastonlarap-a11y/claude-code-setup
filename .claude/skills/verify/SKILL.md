---
name: verify
description: Run the full validate.yml check suite locally (JSON well-formedness, version parity, shellcheck, language anchors, subagent model, template skeletons, context budget, plugin schemas). Use before declaring any change to this repo done.
---
